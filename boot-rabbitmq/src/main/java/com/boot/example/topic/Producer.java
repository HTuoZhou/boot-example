package com.boot.example.topic;
...
public class Producer {
     ...
     * 队列名称1
     */
    public static final String QUEUE_NAME1 = "topics-1";

    /**
     * 队列名称2
     */
    public static final String QUEUE_NAME2 = "topics-2";

    /**
     * 队列名称3
     */
    public static final String QUEUE_NAME3 = "topics-3";
    ...
    public static void main(String[] args) throws Exception {
        ...
        channel.queueBind(QUEUE_NAME3, EXCHANGE_NAME, "#.topic");
        ...
        while (scanner.hasNext()) {
            ...
            // 3、其它参数
            // 4、消息体
            channel.basicPublish(EXCHANGE_NAME, "topic", MessageProperties.PERSISTENT_TEXT_PLAIN, s.getBytes());
